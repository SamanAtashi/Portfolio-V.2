...
const Navbar = () => {
	return (
		<div className="flex justify-between items-center font-light text-xs md:fixed md:bottom-0 md:left-4% md:pl-9 md:pr-5% md:rot md:w-100vh text-Secondary_Light lg:left-3.5%">
